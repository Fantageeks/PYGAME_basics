...
#pygame.draw.circle(畫布名稱，顏色，中心點, 半徑, thinkness) thickness=0(填滿), 1,2..10:線條寬度
...
#pygame.draw.rect(畫布名稱，顏色, (topleft-x, tofleft-y, width, height), thinkness) 0:填滿, 1,2,..10:線條寬度
